...
def main():
	...
	unknown_opcode_function = 'int handle_instr_unknown(jthread_t *jthread, bool wide);'
	function_headers = [f'int handle_instr_{m}(jthread_t *jthread, bool wide);' for m in mnemonics if m != "unknown"]
